...
export function SelectTechModeHeading() {
  ...
  return (
    <motion.header
      ...
      className="absolute left-4 top-4 z-30 max-w-[calc(100vw-2rem)] overflow-hidden rounded-md border border-white/12 bg-[#050812]/70 px-5 py-3 shadow-2xl backdrop-blur-md [box-shadow:0_18px_46px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.13)] sm:left-8 sm:top-6 lg:left-14 lg:top-8"
