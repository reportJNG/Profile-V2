...
const actionClass =
  "group relative inline-flex min-h-11 items-center gap-2 overflow-hidden border border-[color-mix(in_srgb,var(--mode-secondary),transparent_42%)] bg-[linear-gradient(90deg,color-mix(in_srgb,var(--mode-accent),transparent_74%),color-mix(in_srgb,var(--mode-secondary),transparent_86%),rgba(0,0,0,0.28))] px-3.5 py-3 font-mono text-[0.72rem] font-black uppercase leading-none text-[color-mix(in_srgb,var(--mode-secondary),white_30%)] shadow-[0_0_20px_color-mix(in_srgb,var(--mode-secondary),transparent_70%),inset_0_1px_0_rgba(255,255,255,0.08)]";
...
export function ProjectDetail({ isVisible, project }: ProjectDetailProps) {
  ...
  return (
    // This fills whatever container ProjectInventory gives it (absolute inset-0)
    // and scrolls internally — never grows outside
